...
def update_state_action_matrix(state_action_matrix, reward, gamma, observation, new_observation, action, new_action, visit_counter_matrix):
	...
	state_action_matrix[action, col] = state_action_matrix[action, col] + alpha * ( reward + gamma * state_action_matrix[new_action, col_t1] - state_action_matrix[action, col])
